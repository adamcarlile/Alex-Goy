...
wp_tiny_mce();
global $user_ID, $post_ID, $action, $post;
		...
		<div id="post-body-content">
			<div id="titlediv">
				<div id="titlewrap">
					...
					<p>
						<small><a href="#" onclick="jQuery('#post_name').slideToggle(); return false;">Edit Slug</a></small>
					</p>
					<div id="post_name" style="display: none;">
					    <input type="text" name="post_name" value="<?php echo $post->post_name ?>" class="widefat" />
					</div>
